...
public class ContactVo implements Comparable<ContactVo> {
    ...
    private List<PhoneNumberVo> phoneNumbersList;
     ...
     */
    public void setPhoneNumbersList(List<PhoneNumberVo> phoneNumbersList) {
     ...
     */
    public List<PhoneNumberVo> getPhoneNumbersList() {
